                                ...
                                <div class="left-menu">
                                    ...
                                    <div class="menu-main">
                                        <ul>
                                            ...
                                            <li class="has-child"><a href="category_product.php">Shop</a></li>
                                            <li class="has-child"><a href="#">Pages</a>
                                                <ul class="drop-nav">
                                                    <li><a href="index.php"><i class="fa fa-angle-right"></i> Home Page</a></li>
                                                    <li><a href="single_product.php"><i class="fa fa-angle-right"></i> Single Product</a></li>
                                                    <li><a href="category_product.php"><i class="fa fa-angle-right"></i> Category wise product</a></li>
                                                    <li><a href="blog.php"><i class="fa fa-angle-right"></i> Blog</a></li>
                                                    <li><a href="blog-single.php"><i class="fa fa-angle-right"></i> Blog Single Post</a></li>
                                                    <li><a href="checkout.php"><i class="fa fa-angle-right"></i> Checkout</a></li>
                                                    <li><a href="cart.php"><i class="fa fa-angle-right"></i> Cart</a></li>
                                                    <li><a href="wishlist.php"><i class="fa fa-angle-right"></i> Wishlist</a></li>
                                                    <li><a href="profile.php"><i class="fa fa-angle-right"></i> Profile</a></li>
                                                    <li><a href="contact.php"><i class="fa fa-angle-right"></i> Contact</a></li>
                                                    <li><a href="login.php"><i class="fa fa-angle-right"></i> Login & Ragistar</a></li>
                                                </ul>
                                            </li>
                            ...
                            <div class="baner-slider owl-carousel owl-theme">
                                <div class="item ">
                                    <div class="cat-item-inner ">
                                        <a href="#" class="cat-link ">
                                            ...
                                            <img src="img/category/category-11.png" alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>Combo</p>
                                            </div>
                                        </a>
                                ...
                                <div class="item ">
                                    <div class="cat-item-inner ">
                                        <a href="#" class="cat-link ">
                                            <!-- Please your category image here -->
                                            <img src="img/category/category-22.png" alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>kids menus</p>
                                            </div>
                                        </a>
                                ...
                                <div class="item ">
                                    <div class="cat-item-inner ">
                                        <a href="#" class="cat-link ">
                                            <!-- Please your category image here -->
                                            <img src="img/category/category-33.png" alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>pizza</p>
                                            </div>
                                        </a>
                                ...
                                <div class="item ">
                                    <div class="cat-item-inner ">
                                        <a href="#" class="cat-link ">
                                            <!-- Please your category image here -->
                                            <img src="img/category/category-44.png" alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>box meals</p>
                                            </div>
                                        </a>
                                ...
                                <div class="item ">
                                    <div class="cat-item-inner ">
                                        <a href="#" class="cat-link ">
                                            <!-- Please your category image here -->
                                            <img src="img/category/category-55.png" alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>burger</p>
                                            </div>
                                        </a>
                                ...
                                <div class="item ">
                                    <div class="cat-item-inner ">
                                        <a href="#" class="cat-link ">
                                            <!-- Please your category image here -->
                                            <img src="img/category/category3.png" alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>chicken</p>
                                            </div>
                                        </a>
                                ...
                                <div class="item ">
                                    <div class="cat-item-inner ">
                                        <a href="#" class="cat-link ">
                                            <!-- Please your category image here -->
                                            <img src="img/category/category5.png" alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>sauces</p>
                                            </div>
                                        </a>
                                ...
                                <div class="item">
                                    <div class="cat-item-inner ">
                                        <a href="#" class="cat-link ">
                                            <!-- Please your category image here -->
                                            <img src="img/category/category7.png" alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>Drinks</p>
                                            </div>
                                        </a>
